...
- `pipeline_hybrid_optimized.py` — training + evaluation pipeline (internal + external)
- `project_paths.py` — local path resolver for this bundle
- `data/features/` — required hybrid feature CSVs
- `data/metadata/` — required metadata CSVs
- `external/scikit-ExSTraCS-master/` — ExSTraCS dependency
- `models/hybrid_model_v2.pkl` — trained model artifact
- `results/results_hybrid_v2.json` — saved metrics (std + safety)
- `results/DETAILED_RESULTS_REPORT.md` — full experiment report
