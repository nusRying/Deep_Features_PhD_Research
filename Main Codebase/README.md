...
├── phase_v1_baseline/                  # Standard ExSTraCS model with PCA
├── phase_v2_safety/                    # Adds Sensitivity-optimized threshold tuning
├── phase_v3_ensemble/                  # Multi-seed probability averaging (variance reduction)
├── phase_v4_stacking/                  # Stacking ensemble with SMOTE and LogReg meta-committee
├── phase_v5_universal_balance/         # Advanced SMOTE-ENN cleaning + Out-of-Fold (OOF) features
├── phase_v6_global_peak/               # 3-Tier Stacking + LCS Feature Pruning (Theoretical Limit)
└── phase_v7_knowledge_discovery/       # MASTER: All above + Clinical Rule Extraction
```
