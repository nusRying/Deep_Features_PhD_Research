...
class ClassifierSet:
    ...
    def do_correct_set_subsumption(self,model):
        ...
        for ref in self.correctSet:
            ...
            if cl.isSubsumer(model):
                if subsumer == None or model.is_more_general(cl, subsumer):
                    subsumer = cl
        ...
        if subsumer != None:
            ...
            while i < len(self.correctSet):
                ...
                if model.can_subsume(subsumer, self.popSet[ref]):
    ...
    def runGA(self,model,state,phenotype):
        ...
        clP1, clP2 = model.select_parents(self)
    ...
    def subsumeClassifier(self, model,cl, cl1P, cl2P):
        ...
        if cl1P!=None and model.can_subsume(cl1P, cl):
            self.microPopSize += 1
            cl1P.updateNumerosity(1)
            model.trackingObj.subsumptionCount+=1
        elif cl2P!=None and model.can_subsume(cl2P, cl):
            self.microPopSize += 1
